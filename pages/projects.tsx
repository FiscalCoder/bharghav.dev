...
const GetProjects = ({ projectType, projectsData }) => {
  if (!projectType) return <div className="md p-4 md:w-1/2 text-2xl">Data unavailable...</div>

  const projects = projectsData?.filter(({ type }) => type === projectType)

  if (projects?.length === 0) return <div className="md p-4 md:w-1/2">Coming soon...</div>
      ...
      <div className="divide-y divide-gray-200 dark:divide-gray-700">
        ...
        <div className="container py-12">
          ...
          <div className="-m-4 flex flex-wrap">
            <GetProjects projectType="work" projectsData={projectsData} />
          </div>
        </div>
        <div className="container py-12">
          <h3 className="mb-4 text-3xl font-extrabold leading-9 tracking-tight text-gray-900 dark:text-gray-100">
          ...
          <div className="-m-4 flex flex-wrap">
            <GetProjects projectType="self" projectsData={projectsData} />
          </div>
        </div>
      </div>
    </>
